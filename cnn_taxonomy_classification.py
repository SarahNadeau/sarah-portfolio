...
# SET PARAMETERS HERE
data_loc = '/Users/nadeau/Documents/Metagenome_Classification/Classification_Test_Data/raw_seq_train_test/'

seq_len = 150
num_seqs = 400

seq_dim = 4  # 5 if "N" included as valid base
embed_dim = 128
window_size = 3
...
# return arrays of samples, positive examples, and negative examples of the specified batch size
...
# compute l2 norm distance between two sample embeddings
...
# load data, print dataset summary
...
with tf.Session() as sess:
    ...
    for i in range(iterations):
        ...
        if i % logging_frequency == 0:
            ...
            loss, losses, dp, dn, x, o, top_k_losses, normp, xp, xn = sess.run(feed_out, feed_dict=feed_dict)
